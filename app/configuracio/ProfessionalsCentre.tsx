...
interface ProfessionalsCentreProps {
  centreId: string;
}

export function ProfessionalsCentre({ centreId }: ProfessionalsCentreProps) {
  const { t } = useIdioma();
  const {
    professionals,
    afegirProfessional,
  ...
  const professionalsCentre = professionals.filter(
    (professional) => professional.centreId === centreId
  );
        ...
        <FormulariProfessional
          ...
          onDesar={(dades) => {
            if (professionalEdicio) {
              ...
              afegirProfessional({ ...dades, centreId });
            }
